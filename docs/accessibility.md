...
**0 violations across 22 scans.** 628 elements axe could not decide were measured from the rendered pixels instead; none falls short of its threshold, the closest being 4.77:1 where 4.5:1 is required, and 3.19:1 where the text is large enough to owe 3:1. Heaviest screen: 413 KB transferred.
...
| New pack, file rejected | phone | 0 | 24 | 20 | 4.95:1 | 389 KB | 32 |
...
| Dashboard, after a round | phone | 0 | 23 | 60 | 3.19:1 | 388 KB | 32 |
...
| New pack, file rejected | laptop | 0 | 23 | 17 | 5.12:1 | 389 KB | 32 |
...
| Dashboard, after a round | laptop | 0 | 22 | 57 | 3.19:1 | 388 KB | 32 |
...
| --- | --- | --- | --- | --- |
| Element's background color could not be determined due to a pseudo element | 433 | 3.19:1 | 3:1 | “4” on Dashboard, after a round, phone, rgb(216, 111, 99) on rgb(252, 251, 250) |
| Element's background color could not be determined due to a background gradient | 176 | 4.90:1 | 4.5:1 | “Certain: 7 answers, 43% right → 0 answers” on Study, recheck summary, laptop, rgb(95, 95, 102) on rgb(225, 228, 213) |
...
628 text elements measured, 52 decorative marks measured, 171 not measurable (116 covered by another element on this screen; 30 never wholly on screen; 20 no text node of its own to locate; 5 no background pixels to read).
